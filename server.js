...
function respond(res, err, data) {
  ...
  res.end(
    [
      ...
      doc,
      '<footer>',
      '<p><a href="https://github.com/wooorm/dictionary/blob/main/license"><abbr title="Massachusetts Institute of Technology (license)">MIT</abbr></a> © <a href="https://wooorm.com">wooorm</a>',
      '</footer>',
